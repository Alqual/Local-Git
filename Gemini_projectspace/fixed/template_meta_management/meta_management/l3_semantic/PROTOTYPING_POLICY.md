...
**Rule**: No prototype shall jump to TRL 3 (Real NLP integration) without passing a TRL 2 Gate (Mathematical proof/Scrutiny).
...
*   **Operational Protocol**: Refer to [AI_USE_POLICY.md](file:///home/tack-mit/デスクトップ/Gemini_projectspace/meta_management/l3_semantic/AI_USE_POLICY.md) for iterative limits and escalation procedures.
...
*   Work in `experiments/phaseXX/` with standalone or local copies of libraries.
